...
class Header:
    ...
    def header(self):
        ...
        self.subject_label= ctk.CTkEntry(self.scroll_frame, textvariable=self.subject_variable, width=250,height=65, corner_radius=100,border_width=3, justify="center",state="disabled")
        self.subject_label.pack(expand=True, side="left")

        #Creating the time label
        #Note: This is an entry acting as a label because labels don't have a border
        self.time = "00:00:00"
        self.time_variable = tk.StringVar(value = f"Time: {self.time}")
        self.time_label= ctk.CTkEntry(self.scroll_frame, textvariable=self.time_variable, width=250,height=65, corner_radius=100,border_width=3, justify="center",state="disabled")
        ...
        self.score_label= ctk.CTkEntry(self.scroll_frame, textvariable=self.score_variable, width=250,height=65, corner_radius=100,border_width=3, justify="center",state="disabled")
...
class Menu:
    ...
    def menu(self):
        ...
        #Subject Label
        self.subjects_label = ctk.CTkLabel(self.scroll_frame, text="Subjects",width=200,height=50,fg_color="#a3a3a3")
        self.subjects_label.pack(fill="x",pady=10,padx=10)
        ...
        self.search_button = ctk.CTkButton(self.editor_frame,text="",anchor="center",width=30,height=30,border_width=0,image=self.search_image, corner_radius=0,hover_color="#01a9f3")
        self.add_button = ctk.CTkButton(self.editor_frame,text="",anchor="center",width=30,height=30,border_width=0,image=self.add_image, corner_radius=0,hover_color="#01a9f3")
        self.edit_button = ctk.CTkButton(self.editor_frame,text="",anchor="center",width=30,height=30,border_width=0,image=self.edit_image, corner_radius=0,hover_color="#01a9f3")
        self.delete_button = ctk.CTkButton(self.editor_frame,text="",anchor="center",width=30,height=30,border_width=0,image=self.delete_image, corner_radius=0,hover_color="#01a9f3")
